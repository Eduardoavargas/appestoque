...
public class Processo extends HttpServlet{
	...
	public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getParameter("acao").equals("confirmar")) {
			...
			Empresa empresa = new Empresa(nome,razao,email,cnpj,endereco,numero,cep,complemento,bairro,cidade,uuid,null,null,null,null);
...
//				      System.out.println("Data de Publica��o : " + getTagValue("pubDate", eElement));
//				      System.out.println("Titulo : " + getTagValue("title", eElement));
//				      System.out.println("link : " + getTagValue("link", eElement));
//			          System.out.println("Descri��o : " + getTagValue("description", eElement));
				   }
				}
		  } catch (Exception e) {
			e.printStackTrace();
